...
# Model
###############################################################################
flags['layer_1_num_h'] = 2000
flags['layer_1_W_std'] = 0.001
flags['layer_1_side_overlap'] = 4
flags['layer_1_name'] = 'SBM_Lower-' + str(flags['layer_1_num_h'])

flags['layer_2_num_h'] = 50
flags['layer_2_W_std'] = 0.0001
flags['layer_2_name'] = 'GPRBM-' + str(flags['layer_1_num_h']) + '-' + str(flags['layer_2_num_h'])
